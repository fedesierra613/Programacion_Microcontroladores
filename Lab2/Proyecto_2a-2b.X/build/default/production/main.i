...
# 114 "main.c"
    float num[3] = {1, 2, 1};
    float den[3] = {1, -0.4531195164, 0.4663255811};
    float w[3] = {0, 0, 0};
    float num2[3] = {1, 2, 1};
    float den2[3] = {1, -0.3289756775, 0.06458765268};
    float w2[3] = {0, 0, 0};
    float gan[3] = {0.2533015013, 0.1839029938, 0};
...
# 176 "main.c"
            ...
            Palabra_DAC = (DAC_IN) + ((uint16_t)SALIDA);

...
void main(void)
{
    ...
    while (1)
    {
        ...
        if((MiVector.Comando == 1) && (MiVector.iniciar == 1)){
            MiVector.Comando = 0;
            MiVector.iniciar = 0;

            Funcion_RB(&MiVector);
        }
        if((MiVector.Comando == 2) && (MiVector.iniciar == 1)){
            MiVector.Comando = 0;
            MiVector.iniciar = 0;

            Funcion_WB(&MiVector);
        }
        if((MiVector.Comando == 3) && (MiVector.iniciar == 1)){
            MiVector.Comando = 0;
            MiVector.iniciar = 0;

            Funcion_RS(&MiVector);
        }
        if((MiVector.Comando == 4) && (MiVector.iniciar == 1)){
            MiVector.Comando = 0;
            MiVector.iniciar = 0;
            Funcion_WS(&MiVector);
        }
